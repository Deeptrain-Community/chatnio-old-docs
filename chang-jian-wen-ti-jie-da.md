...
* 504 Gateway Timeout：服务异常（常发生于服务器满负载运行时），请联系网站相关人员解决。
* 503 Service Unavailable：服务暂时不可用。常发生于上游流量过大无法提供服务（如 Poe 逆向）。
* 500 Internal Server Error：上游服务端异常 （如 OpenAI 受到的流量过大时拒绝服务）。
* 404 Not Found： 出现于逆向模型。如上文所述，会有逆向账户额度不足的情况，为正常现象，等账号池额度恢复即可。
* 403 Forbidden：拒绝服务。参数设置不正确，速率限制，或者上下文 Token 大小超过该模型的最大上下文。
